...
export default function Footer() {
  ...
  return (
    <footer className="py-12 px-6 md:px-12 lg:px-24 border-t border-gray-200 dark:border-white/5 bg-gray-100 dark:bg-dark-surface transition-colors duration-300">
